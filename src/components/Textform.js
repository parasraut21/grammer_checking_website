...
<button className="btn btn-outline-primary mx-2"  onClick={handleuptext}  >Convert To Upper case</button>
<button className="btn btn-primary mx-2"  onClick={handlelotext}  >Convert To Lower Case</button>
<button className="btn btn-outline-primary mx-2"  onClick={clearttext}  >Clear Text</button>
<button className='btn btn-primary mx-2' onClick={downloadTxtFile}>Download Text file</button>
  ...
  <div className="container my-3" style={{color:props.mode==='dark'?'white':'#042743'}}>
      ...
      <h2>Preview</h2>
      <p><b>{text.length>0?text:"Enter Your Text To Preview"}</b></p>
